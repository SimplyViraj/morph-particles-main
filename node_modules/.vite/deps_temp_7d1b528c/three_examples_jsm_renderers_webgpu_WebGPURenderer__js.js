...
var RenderObjects = class {
  constructor(renderer, nodes, geometries, pipelines, bindings, info) {
    ...
    this.info = info;
    this.chainMaps = {};
    this.dataMap = new DataMap_default();
  }
...
var Geometries = class extends DataMap_default {
  constructor(attributes, info) {
    ...
    this.attributeFrame = /* @__PURE__ */ new WeakMap();
  }
  has(renderObject) {
...
var Pipelines = class extends DataMap_default {
  ...
  getForRender(renderObject) {
    ...
    if (this._needsRenderUpdate(renderObject)) {
      ...
      if (stageVertex === void 0) {
        ...
        stageVertex = new ProgrammableStage_default(nodeBuilder.vertexShader, "vertex");
      ...
      if (stageFragment === void 0) {
        ...
        stageFragment = new ProgrammableStage_default(nodeBuilder.fragmentShader, "fragment");
  ...
  _needsRenderUpdate(renderObject) {
    ...
    return needsUpdate || data.pipeline === void 0;
  }
};
        ...
        if (image === void 0) {
          ...
          if (texture2.images) {
            ...
            for (const image2 of texture2.images) {
              images.push(this._getUploadImage(image2));
            }
...
var Nodes = class extends DataMap_default {
  ...
  getForRenderChainKey(renderObject) {
    const { object, material, lightsNode, context: context2 } = renderObject;
    return [object.geometry, material, lightsNode, context2];
  }
  getForRender(renderObject) {
...
var Renderer = class {
  constructor(backend) {
    ...
    this._animation = new Animation_default();
  ...
  async init() {
    ...
    this._initPromise = new Promise(async (resolve, reject) => {
      ...
      this._geometries = new Geometries_default(this._attributes, this._info);
      this._textures = new Textures_default(backend, this._info);
      this._pipelines = new Pipelines_default(backend, this._nodes);
      this._bindings = new Bindings_default(backend, this._nodes, this._textures, this._attributes, this._pipelines, this._info);
      this._objects = new RenderObjects_default(this, this._nodes, this._geometries, this._pipelines, this._bindings, this._info);
  ...
  clear(color = true, depth = true, stencil = true) {
    const renderContext = this._currentRenderContext || this._lastRenderContext;
    if (renderContext)
      this.backend.clear(renderContext, color, depth, stencil);
  }
  clearColor() {
...
var SampledCubeTexture = class extends SampledTexture {
  constructor(name, texture2) {
    super(name, texture2);
...
var NodeSampledCubeTexture = class extends SampledCubeTexture {
  constructor(name, textureNode) {
    super(name, textureNode ? textureNode.value : null);
    this.textureNode = textureNode;
  }
...
var GLSLNodeBuilder = class extends NodeBuilder_default {
  ...
  getTexture(texture2, textureProperty, uvSnippet) {
  ...
  getTextureLevel(texture2, textureProperty, uvSnippet, biasSnippet) {
    ...
    if (uniformGPU === void 0) {
      if (type === "texture") {
        ...
        if (uniformsGroup === void 0) {
          uniformsGroup = new UniformsGroup_default(shaderStage + "NodeUniforms");
  ...
  getDomElement() {
    ...
    if (domElement === null) {
      ...
      if ("setAttribute" in domElement)
        domElement.setAttribute("data-engine", `three.js r${REVISION}`);
...
var WebGLBackend = class extends Backend_default {
  ...
  updateTexture(texture2, options) {
    ...
    const { textureGPU, glTextureType, glFormat, glType } = this.get(texture2);
...
var WGSLNodeBuilder = class extends NodeBuilder_default {
  ...
  _getSampler(texture2, textureProperty, uvSnippet, shaderStage = this.shaderStage) {
    if (shaderStage === "fragment") {
      return `textureSample( ${textureProperty}, ${textureProperty}_sampler, ${uvSnippet} )`;
    } else {
      return this.getTextureLoad(texture2, textureProperty, uvSnippet);
    }
  }
  ...
  _getSamplerLevel(texture2, textureProperty, uvSnippet, biasSnippet, shaderStage = this.shaderStage) {
    if (shaderStage === "fragment" && this.isUnfilterable(texture2) === false) {
      ...
      return this.getTextureLoad(texture2, textureProperty, uvSnippet, biasSnippet);
    }
  }
  getTextureLoad(texture2, textureProperty, uvSnippet, biasSnippet = "0") {
  ...
  getTexture(texture2, textureProperty, uvSnippet, shaderStage = this.shaderStage) {
    ...
    if (texture2.isVideoTexture === true) {
      ...
      snippet = this.getTextureLoad(texture2, textureProperty, uvSnippet);
    } else {
      snippet = this._getSampler(texture2, textureProperty, uvSnippet, shaderStage);
    }
    return snippet;
  }
  getTextureCompare(texture2, textureProperty, uvSnippet, compareSnippet, shaderStage = this.shaderStage) {
    if (shaderStage === "fragment") {
  ...
  getTextureLevel(texture2, textureProperty, uvSnippet, biasSnippet, shaderStage = this.shaderStage) {
    ...
    if (texture2.isVideoTexture === true) {
      ...
      snippet = this._getSamplerLevel(texture2, textureProperty, uvSnippet, biasSnippet, shaderStage);
    }
    return snippet;
  }
  ...
  getUniformFromNode(node, type, shaderStage, name = null) {
    ...
    if (nodeData.uniformGPU === void 0) {
      ...
      if (type === "texture" || type === "cubeTexture") {
        ...
        let uniformsGroup = this.uniformsGroup[shaderStage];
        if (uniformsGroup === void 0) {
          uniformsGroup = new UniformsGroup_default("nodeUniforms");
...
`;
  ...
  buildCode() {
	...
	`;
      ...
      stageData.vars = this.getVars(shaderStage);
      stageData.codes = this.getCodes(shaderStage);
      stageData.returnType = outputNode !== void 0 && outputNode.isOutputStructNode === true ? outputNode.nodeType : "@location( 0 ) vec4<f32>";
      stageData.flow = flow;
    }
    if (this.material !== null) {
...
// node_modules/three/examples/jsm/renderers/webgpu/utils/WebGPUTextureMipmapUtils.js
var WebGPUTextureMipmapUtils = class {
  constructor(device) {
    this.device = device;
...
var WebGPUTextureMipmapUtils_default = WebGPUTextureMipmapUtils;
...
var WebGPUTextureUtils = class {
  ...
  updateTexture(texture2, options) {
    ...
    if (texture2.isDataTexture || texture2.isDataArrayTexture || texture2.isData3DTexture) {
      ...
      this._copyCubeMapToTexture(options.images, texture2, textureData.texture, textureDescriptorGPU);
  ...
  _copyCubeMapToTexture(images, texture2, textureGPU, textureDescriptorGPU) {
    for (let i = 0; i < 6; i++) {
  ...
  _generateMipmaps(textureGPU, textureDescriptorGPU, baseArrayLayer = 0) {
    if (this.mipmapUtils === null) {
      this.mipmapUtils = new WebGPUTextureMipmapUtils_default(this.backend.device);
    }
...
//# sourceMappingURL=three_examples_jsm_renderers_webgpu_WebGPURenderer__js.js.map
